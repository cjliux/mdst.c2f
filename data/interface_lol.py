...
def sample_map_and_batch_4_lol(args, pairs, batch_size, shuffle, slot_temp):
    ...
    data_loader = LookAheadBatchStream(
                        ...
                        shuffle=shuffle,
                        collate_fn=collate_fn,
                        look_ahead=args["lol_look_ahead"],
                        la_pad='cycle')
    return data_loader


def prepare_data_loader_4_lol(args, data_path, training):
    ...
    if training:
        ...
        train_loader = sample_map_and_batch_4_lol(args, pair_train, batch_size, True, slot_train)
