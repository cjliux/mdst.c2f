...
parser.add_argument('-mbsz','--meta_batch', required=False, type=int, default=5)
parser.add_argument('-mebsz','--meta_eval_batch', required=False, type=int, default=15)
parser.add_argument('--rich_domains', type=str, default='restaurant')
parser.add_argument('--rich_data_ratio', type=float, default=1)
parser.add_argument('--few_domains', type=str, default='hotel,train,attraction')
parser.add_argument('--few_data_ratio', type=float, default=0.01)
parser.add_argument('--unseen_domains', type=str, default='taxi')
